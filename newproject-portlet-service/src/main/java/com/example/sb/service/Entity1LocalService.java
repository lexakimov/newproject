...
/**
 * Provides the local service interface for Entity1. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author akimov
 * @see Entity1LocalServiceUtil
...
public interface Entity1LocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link Entity1LocalServiceUtil} to access the entity1 local service. Add custom service methods to {@link com.example.sb.service.impl.Entity1LocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
