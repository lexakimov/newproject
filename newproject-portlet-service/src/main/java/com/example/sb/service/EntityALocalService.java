...
/**
 * Provides the local service interface for EntityA. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author akimov
 * @see EntityALocalServiceUtil
...
public interface EntityALocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link EntityALocalServiceUtil} to access the entity a local service. Add custom service methods to {@link com.example.sb.service.impl.EntityALocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
