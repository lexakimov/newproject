...
/**
 * Provides the local service interface for Entity2. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author akimov
 * @see Entity2LocalServiceUtil
...
public interface Entity2LocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link Entity2LocalServiceUtil} to access the entity2 local service. Add custom service methods to {@link com.example.sb.service.impl.Entity2LocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
