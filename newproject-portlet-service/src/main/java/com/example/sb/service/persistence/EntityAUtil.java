...
/**
 * The persistence utility for the entity a service. This utility wraps {@link EntityAPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class EntityAUtil {
    private static EntityAPersistence _persistence;
     ...
     */
    public static void clearCache(EntityA entityA) {
        getPersistence().clearCache(entityA);
    }
     ...
     */
    public static List<EntityA> findWithDynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
     ...
     */
    public static List<EntityA> findWithDynamicQuery(
     ...
     */
    public static EntityA update(EntityA entityA) throws SystemException {
        return getPersistence().update(entityA);
    }

    /**
     * @see com.liferay.portal.service.persistence.BasePersistence#update(com.liferay.portal.model.BaseModel, ServiceContext)
     */
    public static EntityA update(EntityA entityA, ServiceContext serviceContext)
        throws SystemException {
        return getPersistence().update(entityA, serviceContext);
    }
    ...
    */
    public static void cacheResult(com.example.sb.model.EntityA entityA) {
        getPersistence().cacheResult(entityA);
    }
    ...
    */
    public static void cacheResult(
        ...
        getPersistence().cacheResult(entityAs);
    }
    ...
    */
    public static com.example.sb.model.EntityA create(long id) {
    ...
    */
    public static com.example.sb.model.EntityA remove(long id)
        throws com.example.sb.NoSuchEntityAException,
            com.liferay.portal.kernel.exception.SystemException {
        return getPersistence().remove(id);
    }

    public static com.example.sb.model.EntityA updateImpl(
        com.example.sb.model.EntityA entityA)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getPersistence().updateImpl(entityA);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.example.sb.model.EntityA findByPrimaryKey(long id)
        throws com.example.sb.NoSuchEntityAException,
            com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.example.sb.model.EntityA fetchByPrimaryKey(long id)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<com.example.sb.model.EntityA> findAll()
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static EntityAPersistence getPersistence() {
        if (_persistence == null) {
            _persistence = (EntityAPersistence) PortletBeanLocatorUtil.locate(com.example.sb.service.ClpSerializer.getServletContextName(),
                    EntityAPersistence.class.getName());

            ReferenceRegistry.registerReference(EntityAUtil.class,
                "_persistence");
        }
     ...
     */
    public void setPersistence(EntityAPersistence persistence) {
    }
}
