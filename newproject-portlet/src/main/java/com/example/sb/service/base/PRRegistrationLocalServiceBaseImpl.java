...
import com.example.sb.service.PRRegistrationLocalService;
...
/**
 * Provides the base implementation for the p r registration local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.example.sb.service.impl.PRRegistrationLocalServiceImpl}.
 * </p>
 *
 * @author akimov
 * @see com.example.sb.service.impl.PRRegistrationLocalServiceImpl
 * @see com.example.sb.service.PRRegistrationLocalServiceUtil
 * @generated
 */
public abstract class PRRegistrationLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements PRRegistrationLocalService,
        IdentifiableBean {
    @BeanReference(type = com.example.sb.service.PRRegistrationLocalService.class)
    protected com.example.sb.service.PRRegistrationLocalService prRegistrationLocalService;
    @BeanReference(type = PRRegistrationPersistence.class)
    protected PRRegistrationPersistence prRegistrationPersistence;
    @BeanReference(type = com.example.sb.service.PRUserLocalService.class)
    protected com.example.sb.service.PRUserLocalService prUserLocalService;
    ...
    private PRRegistrationLocalServiceClpInvoker _clpInvoker = new PRRegistrationLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.example.sb.service.PRRegistrationLocalServiceUtil} to access the p r registration local service.
     */
    ...
    public PRRegistration addPRRegistration(PRRegistration prRegistration)
        ...
        return prRegistrationPersistence.update(prRegistration);
    }
    ...
    @Override
    public PRRegistration deletePRRegistration(long registrationId)
        throws PortalException, SystemException {
        return prRegistrationPersistence.remove(registrationId);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public PRRegistration deletePRRegistration(PRRegistration prRegistration)
        throws SystemException {
        return prRegistrationPersistence.remove(prRegistration);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(PRRegistration.class,
    ...
    @Override
    public PRRegistration fetchPRRegistration(long registrationId)
        throws SystemException {
        return prRegistrationPersistence.fetchByPrimaryKey(registrationId);
    }
    ...
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return prRegistrationPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    public com.example.sb.service.PRRegistrationLocalService getPRRegistrationLocalService() {
    ...
    public void setPRRegistrationLocalService(
        com.example.sb.service.PRRegistrationLocalService prRegistrationLocalService) {
     ...
     */
    public com.example.sb.service.PRUserLocalService getPRUserLocalService() {
    ...
    public void setPRUserLocalService(
        com.example.sb.service.PRUserLocalService prUserLocalService) {
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.example.sb.model.PRRegistration",
            prRegistrationLocalService);
    }
